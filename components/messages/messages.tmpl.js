...
;pug_debug_line = 8;pug_debug_filename = "components\u002Fmessages\u002Fmessages.tmpl.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = (new Date(message.timestamp).toLocaleString('ru-RU', { hour: '2-digit', minute: '2-digit', second: '2-digit' }))) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Date" in locals_for_with?locals_for_with.Date:typeof Date!=="undefined"?Date:undefined,"messages" in locals_for_with?locals_for_with.messages:typeof messages!=="undefined"?messages:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}